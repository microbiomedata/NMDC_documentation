...
URI: [nmdc:ReadBasedAnalysisActivity](https://microbiomedata/meta/ReadBasedAnalysisActivity)


[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[WorkflowExecutionActivity],[Database]++-%20read%20based%20analysis%20activity%20set%200..*>[ReadBasedAnalysisActivity&#124;execution_resource(i):string;git_url(i):string;type(i):string;started_at_time(i):datetime;ended_at_time(i):datetime;id(i):string;name(i):string%20%3F;used(i):string%20%3F],[WorkflowExecutionActivity]^-[ReadBasedAnalysisActivity],[NamedThing],[Database],[Activity])](https://yuml.me/diagram/nofunky;dir:TB/class/[WorkflowExecutionActivity],[Database]++-%20read%20based%20analysis%20activity%20set%200..*>[ReadBasedAnalysisActivity&#124;execution_resource(i):string;git_url(i):string;type(i):string;started_at_time(i):datetime;ended_at_time(i):datetime;id(i):string;name(i):string%20%3F;used(i):string%20%3F],[WorkflowExecutionActivity]^-[ReadBasedAnalysisActivity],[NamedThing],[Database],[Activity])
 ...
 *  **[Database](Database.md)** *[read based analysis activity set](read_based_analysis_activity_set.md)*  <sub>0..\*</sub>  **[ReadBasedAnalysisActivity](ReadBasedAnalysisActivity.md)**
