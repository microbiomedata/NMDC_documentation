...
![find example ste 5](../_static/images/howto_guides/api_gui/find_example_step5.png)
Note that a curl request and request url are provided as well for command line usage:
![find example note](../_static/images/howto_guides/api_gui/find_example.note.png)
